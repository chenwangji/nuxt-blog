  ...
  <div id="share">
    <div
      ...
      <a
        ...
        <i class="iconfont icon-google-plus"/>
      </a>
      <a
        title="linkedin"
        rel="nofollow"
...
export default {
  ...
  mounted() {
    new Clipboard(this.$refs.share_copy_btn)
  },
  ...
  methods: {
    ...
    shareWindow(url) {
      ...
      // screen.awailWidth 获取屏幕宽度
      // screen.awailHeight 获取屏幕高度
      // 居中算法：
      // 左右居中 （屏幕宽度 - 窗口宽度）/ 2
      // 上下居中 （屏幕高度 - 窗口高度）/ 2
      ...
      const params = `top=${atop},left=${aleft},width=${awidth},height=${aheight},${otherParams}`
